...
class FeatureTypeUpdateRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'name' => ['required','string','min:2','max:150','regex:/^[a-zA-Z0-9\- ]+$/u',Rule::unique('feature_types','name')->ignore($this->route('featureType')->id)],
